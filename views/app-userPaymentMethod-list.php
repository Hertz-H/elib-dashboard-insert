...
<div class="card"> 
<a href="/add_user_payment" style ="width:120px;margin-left: auto;margin-top:10px;margin-right:10px"class="dt-button add-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" ><span><i class="bx bx-plus me-0 me-sm-2"></i><span class="d-none d-lg-inline-block">اضافة </span></span></a>

  <h5 class="card-header">طرق دفع المستخدم</h5> 
