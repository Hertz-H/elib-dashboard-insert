          ...
          <!-- enctype="multipart/form-data" -->
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <label class="form-label" for="email">الصورة</label>
                <div class="input-group input-group-merge">
                  <input class="form-control" type="file" id=" " name="book_img" placeholder="john.doe" aria-label="john.doe" aria-describedby="email3" />
                  <span class="input-group-text" id="email3"> </span>
                </div>
              </div> -->
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <option value="1">دار الحكمة</option>
                </select>
              </div>
              
              <div class="col-md-6">
                <label class="form-label" for="alt-num">عدد الصفحات </label>
                <input type="text" id="alt-num" name="page_num"class="form-control phone-mask" placeholder="" />
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="alt-num" name="quantity"class="form-control" placeholder="" />
              </div>
